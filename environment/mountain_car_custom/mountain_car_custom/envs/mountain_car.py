    ...
    * v0: Initial versions release (1.0.0)
    ...
    def render(self):
        ...
        if self.last_action != NO_MOVEMENT:
            ...
            scale = self.screen_width / world_width
            pos = self.state[0]
            arrow_start = int((pos - self.min_position) * scale), int(self._height(pos) * scale + carheight)
            if self.last_action == 0:  # Left
                arrow_start = arrow_start[0] - ((carwidth / 2) + 10), arrow_start[1]
