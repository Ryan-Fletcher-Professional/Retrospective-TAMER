...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', default="frequency", type=str, help="performance/frequency/timing")
    ...
    # TODO :
    #   Compare live vs. retrospective directly
    ...
    for filename in os.listdir(args.load):
        ...
        if name is not None:
            ...
            if (env_name == TTT_MODE) and (args.mode != "performance"):
                print("Skipped (TTT):", filename)
                continue
            elif env_name == MOUNTAIN_CAR_MODE:
